    ...
    <body>
        ...
        >
            <a
                ...
                >Nền tảng sự kiện</a
            >
            <span class="navbar-organizer w-100"
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <form
                        ...
                        novalidate
                        action="{{route('ticketHandle', $event->id)}}"
                        method="POST"
                    >
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mb-3">
                                <label for="selectSpecialValidity"
                                    >Hiệu lực đặc biệt</label
                                >
                                <select
                                    class="form-control"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mb-3">
                                <label for="inputAmount"
                                    >Số lượng vé tối đa được bán</label
                                >
                                <input
                                    type="number"
                                    class="form-control @if(Session::has('amount')) is-invalid @endif"
                                    id="inputAmount"
                                    name="amount"
                                    placeholder=""
                                    value="0"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mb-3">
                                <label for="inputValidTill"
                                    >Vé có thể được bán đến</label
                                >
                                <input
                                    type="text"
                                    class="form-control @if(Session::has('date')) is-invalid @endif"
                                    id="inputValidTill"
                                    name="valid_until"
                        ...
                        <a href="{{route('event', $event->slug)}}" class="btn btn-link"
                            >Bỏ qua</a
                        >
                    </form>
                </main>
