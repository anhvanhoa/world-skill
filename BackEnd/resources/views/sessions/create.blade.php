            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    >
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mb-3">
                                <label for="inputSpeaker"
                                >Người trình bày</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mb-3">
                                ...
                                @foreach($rooms as $room)
                                    <option value="{{$room->id}}">{{$room->name}} / {{$room->name_channel}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <a href="events/detail.html" class="btn btn-link"
                            >Bỏ qua</a
                        >
                    </form>
                </main>
