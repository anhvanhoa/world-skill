    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <form class="needs-validation" action="{{ route('create-event') }}" method="post">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('date') is-invalid @enderror" id="inputDate" name="date" placeholder="yyyy-mm-dd" value="">
                            @error('date')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
